...
| 任务 | 触发时刻 | 产物 |
|---|---|---|
| 每日舆情雷达 | 工作日收盘后 15:30 | 量价异动 / 公告速递 / 行业催化剂 / 卖方覆盖 |
...
会注册 `AshareDaily`(工作日15:30)、`AshareBiweekly1/16`(每月1/16日20:00)、`AshareWeeklyFri`(周五16:00)。
若改用 Linux，可直接在 crontab 写入：`30 15 * * 1-5`、`0 20 1,16 * *`、`0 16 * * 5`。
